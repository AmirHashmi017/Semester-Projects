...
class SortUI(QWidget):
    def __init__(self, parent=None):
        super(SortUI, self).__init__(parent)
        self.setupUi()
    ...
    def setupUi(self):
        ...
        self.AttributeComboBox_2 = QtWidgets.QComboBox(self)
        ...
        self.SortButton.setGeometry(QtCore.QRect(580, 200, 75, 26))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def sortData(self):
        self.runtime.setGeometry(QtCore.QRect(70, 200, 130, 21))
