...
{
    public class GoldMemberShipCard : MemberShipCard
    {
        private TimeSpan MemberShipDuration;
        private double MemberShipPrice;
        private double MonthlyProfit;

        public GoldMemberShipCard(string Number, string Name, string Tier) : base(Number, Name, Tier)
        {
            MemberShipDuration = TimeSpan.FromDays(365);
