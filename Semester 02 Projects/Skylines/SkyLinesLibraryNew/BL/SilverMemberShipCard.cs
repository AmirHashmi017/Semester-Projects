...
{
    //This 'SilverMemberShipCard' Class is a child class which is inheriting 'MemberShipCard'Class.
    public class SilverMemberShipCard : MemberShipCard
    {
        private TimeSpan MemberShipDuration;
        private double MemberShipPrice;
        private double MonthlyProfit;

        public SilverMemberShipCard(string Number, string Name, string Tier) : base(Number, Name, Tier)
        {
            MemberShipDuration = TimeSpan.FromDays(182);
